...
for g=1:length(grids)
    % load data
    d1=load(['d:/results/ecogres/g' num2str(g) 'mpsd' reref_append '.mat'],'mpsd','f');
    f=d1.f;
    ...
    % save figure
    saveas(gcf,['d:/results/ecogres/figures/MPSD_' grids(g).filename '.fig']);
    saveas(gcf,['d:/results/ecogres/figures/MPSD_' grids(g).filename '.eps'],'epsc2');
    saveas(gcf,['d:/results/ecogres/figures/MPSD_' grids(g).filename '.png']);
