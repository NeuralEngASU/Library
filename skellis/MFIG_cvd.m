...
for g=1:length(grids)
    ...
    d{g}=load(['D:\Kevin\SpencerPaper\201203\g' num2str(g) 'cvd_' upper(ref) '.mat']);
    d{g}.bad=[];
end
...
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures/MCVD_' upper(ref) '.fig']);
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures/MCVD_' upper(ref) '.png']);
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures/MCVD_' upper(ref) '.eps'],'epsc2');
