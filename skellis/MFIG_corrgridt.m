...
% load data
load(['D:\Kevin\SpencerPaper\201203\g1cvd_' upper(ref) '.mat']);
...
% save
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRIDT_' grids(1).filename '_' upper(ref) '.fig']);
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRIDT_' grids(1).filename '_' upper(ref) '.png']);
saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRIDT_' grids(1).filename '_' upper(ref) '.eps'],'epsc2');
