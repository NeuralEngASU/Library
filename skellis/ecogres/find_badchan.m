...
for g=4%1:length(grids)
    ...
    % load data
    d1=load(fullfile(srcdir,sprintf('g%dmccf%s.mat',g,reref_append)),'mccf','lags','chanpairs');
    lags=d1.lags;
    
    % load data
    d2=load(fullfile(srcdir,sprintf('g%dmpsd%s.mat',g,reref_append)),'mpsd','f');
    f=d2.f;
