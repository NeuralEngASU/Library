...
%
g=g+1;
grids(g).subject='seattle1';
grids(g).label='Subdural Macro ECoG';
grids(g).filename='subduralmacro';
...
grids(g).badchan=[35];
grids(g).spacing=10;
grids(g).sources(1).file='D:\Spencer\seattle\for_spencer_8x8_ECoG.mat';
grids(g).sources(1).nschans=64;
grids(g).sources(1).block=[0 999.412];
