...
for g=1:length(grids)
    load(['d:/Spencer/ecogres/g' num2str(g) 'mccf_' upper(ref) '.mat'],'mccf','chanpairs','lags','spacing','layout');
    ...
    saveas(gcf,['d:/Spencer/ecogres/figures/MCCF_' grids(g).shortname '_' upper(ref) '.fig']);
    saveas(gcf,['d:/Spencer/ecogres/figures/MCCF_' grids(g).shortname '_' upper(ref) '.png']);
    saveas(gcf,['d:/Spencer/ecogres/figures/MCCF_' grids(g).shortname '_' upper(ref) '.eps'],'epsc2');
