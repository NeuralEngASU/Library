...
for g=1:length(grids)
    load(['D:\Kevin\SpencerPaper\201203\g' num2str(g) 's1.mat']);
    ...
    saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRID_' grids(g).shortname '_' upper(ref) '.fig']);
    saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRID_' grids(g).shortname '_' upper(ref) '.png']);
    saveas(gcf,['D:\Kevin\SpencerPaper\201203\figures\MCRGRID_' grids(g).shortname '_' upper(ref) '.eps'],'epsc2');
%     close(gcf);
end