...
%     nw=2*matlabpool('size');
    ...
    % save results
    save(['D:\Kevin\SpencerPaper\201203\g' num2str(g) 'mcoh_' upper(ref)],'mcoh','mphi','f','chanpairs','spacing','layout');
    % % save(['d:\Spencer\ecogres\g' num2str(g) 'mcoherr_' upper(ref)],'mconfc','mphistd','mcerr','chanpairs','f','spacing','layout');
    save(['D:\Kevin\SpencerPaper\201203\g' num2str(g) 'mcx_' upper(ref)],'mcx','f','chanpairs','spacing','layout');
end