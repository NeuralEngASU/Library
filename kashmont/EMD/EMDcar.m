...
grids{1} = [1 64; 65 80; 81 96; 97 102; 103 108; 109 114; 115 120]; %2014PP01
grids{2} = [1 64; 65 70; 71 76; 77 82; 83 88; 89 94]; %2014PP02
grids{3} = [1 64; 65 70; 71 76; 77 84; 85 89]; %2014PP04
grids{4} = [1 64; 65 68; 69 74; 75 78; 79 82; 83 88]; %2014PP05
grids{5} = [1 64; 65 70; 71 76; 77 82; 83 86; 87 90]; %2014PP06
grids{6} = [1 16; 17 32; 33 52; 53 72; 73 78; 79 84; 85 90]; %2014PP07
...
%         load(['E:\data\human CNS\EMD\Sz\clips\new\',name,'.mat']);
        load(['E:\data\human CNS\EMD\FullFile\',name,'.mat']);
...
%     header.IctalClassifier = name(9:end);
    ...
    save(['E:\data\human CNS\EMD\FullFile\CAR\' num2str(patnum{f}) '_CAR.mat'],'data', 'header','-v7.3');
