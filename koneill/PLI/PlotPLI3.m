...
function [] = PlotPLI2(pathName, g, p, chanPairs, type, mapCol)
...
%                 colorPatch = colorMat(floor(tmpPLI(chanIdx,chanIdx2)/length(mapCol) * 127+1),:);
    ...
    title(sprintf('%s: Significance', g.subject))
