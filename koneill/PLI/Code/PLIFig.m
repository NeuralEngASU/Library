...
subplot(2,2,2)
hist(squeeze(PLI(12,3,:))); title(sprintf('C17 vs C2, Positive-Significant')); xlabel('PLI'); ylabel('Count');
% hist(squeeze(PLI(12,3,:))); title(sprintf('C12 vs C3, Positive-Significant')); xlabel('PLI'); ylabel('Count');
xlim([0,0.3])

subplot(2,2,3)
hist(squeeze(PLI(23,6,:))); title(sprintf('C22 vs C6, Non-Significant')); xlabel('PLI'); ylabel('Count');
% hist(squeeze(PLI(22,6,:))); title(sprintf('C22 vs C6, Non-Significant')); xlabel('PLI'); ylabel('Count');
xlim([0,0.3])

subplot(2,2,4)
hist(squeeze(PLI(20,7,:))); title(sprintf('C24 vs C5, Negative-Significant')); xlabel('PLI'); ylabel('Count');
